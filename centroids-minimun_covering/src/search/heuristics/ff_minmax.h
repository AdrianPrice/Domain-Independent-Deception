#ifndef HEURISTICS_FF_MINMAX_H
#define HEURISTICS_FF_MINMAX_H
...
*/
    class FFHeuristicMinMax : public additive_heuristic::AdditiveHeuristic {
    ...
    public:
        explicit FFHeuristicMinMax(const options::Options &opts);
    };
}
