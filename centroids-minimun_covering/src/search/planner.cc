...
string state_to_compute;
string estimation;
string type_of_exploration;
string plan_type;
string search_paradigm;
string goals_file;
vector <string> header;
std::vector<int> global_contador_fmin(99999999,0);
std::vector<GlobalState> best_states;
int best_f = 999999;
std::vector<GP> goals_probabilities;
std::vector<std::pair<int,int>> goal_propositions_bis;
std::vector <string> static_predicates;
bool test;
