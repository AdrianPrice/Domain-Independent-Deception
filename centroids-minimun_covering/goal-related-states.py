...
def main():
    ...
    output_file_state_name = pb_number + '_' + domain_name + "_" + options.state + "_" + options.plan_type +".txt"
    output_file_state_name_runtime = pb_number + '_' + domain_name + "_" + options.state + "_" + options.plan_type +"-runtime.txt"
