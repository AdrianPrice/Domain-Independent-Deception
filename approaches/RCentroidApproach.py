...
class RCentroidApproach(CentroidsApproach):
    NAME = "R-Centroid Approach"
    DESC = "Achieves the r-centroid between all candidate goals and the real goal, then the real goal"
    ...
    def __init__(self, extractedLandmarks, realTask, hashableRealGoal, dname):
        ...
        self.centroidsFile = "_r-centroid_heuristic_greedy.txt"