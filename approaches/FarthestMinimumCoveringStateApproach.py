...
class FarthestMinimumCoveringStateApproach(CentroidsApproach):
    NAME = "Farthest Minimum Covering State Approach"
    ...
    def __init__(self, extractedLandmarks, realTask, hashableRealGoal, dname):
        ...
        self.centroidsFile = "minimum-covering_heuristic_greedy-real_goal-farthest_goal.txt"