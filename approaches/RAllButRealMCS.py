...
class RAllButRealMCSApproach(CentroidsApproach):
    NAME = "R-All but Real Minimum Coverinst State Approach"
    ...
    def __init__(self, extractedLandmarks, realTask, hashableRealGoal, dname):
        ...
        self.centroidsFile = "r-minimum-covering_heuristic_greedy-no_real_goal.txt"